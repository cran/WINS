covipcw.win.stat<-function(df,Z_t_trt = NULL,Z_t_con = NULL,n_total,
                        arm.name = c(1,2),id_trt,id_con,
  ...
  KL = covipcw.adjusted.KL(win_status = win_status, trt = trt,con = con,trt_con = trt_con,
