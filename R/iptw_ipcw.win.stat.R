iptw_ipcw.win.stat<-function(df,iptw.weight,n_total,arm.name = c(1,2),id_trt,id_con,
  ...
  weighted_win_status = iptw_ipcw.adjusted.KL(win_status = win_status, trt = trt,con = con, trt_con = trt_con,
